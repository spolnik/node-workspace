...
/***/ function(module, exports, __webpack_require__) {
	...
	var market_controller_1 = __webpack_require__(35);
	var symbol_controller_1 = __webpack_require__(39);
	var appSettings = {
	    isDebug: true,
	    ...
	    onErrorHandler: function (e) { return console.log(JSON.stringify(e)); }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app_event_1 = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mediator_1 = __webpack_require__(6);
	var app_event_1 = __webpack_require__(5);
	var router_1 = __webpack_require__(8);
	var App = (function () {
	    function App(appSettings) {
	        this.controllers = appSettings.controllers;
	        this.mediator = new mediator_1.Mediator(appSettings.isDebug || false);
	        this.router = new router_1.Router(this.mediator, appSettings.defaultController, appSettings.defaultAction);
	        this.dispatcher = new dispatcher_1.Dispatcher(this.mediator, this.controllers);
	    ...
	    App.prototype.initialize = function () {
	        ...
	        this.mediator.subscribe(new app_event_1.AppEvent("app.error", null, function (e, data) {
	            _this.onErrorHandler(data);
	        }));
	        this.mediator.publish(new app_event_1.AppEvent("app.initialize", null, null));
	    };
	    return App;
	}());
	exports.App = App;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dispatcher = (function (_super) {
	    ...
	    Dispatcher.prototype.getController = function (controllerDetailsArray) {
	        var hashMap = {};
	        if (controllerDetailsArray.length <= 0) {
	            this.triggerEvent(new app_event_1.AppEvent("app.error", "Cannot create an application without at least one contoller.", null));
	        }
	        for (var _i = 0, controllerDetailsArray_1 = controllerDetailsArray; _i < controllerDetailsArray_1.length; _i++) {
	            var controllerDetails = controllerDetailsArray_1[_i];
	            var controllerName = controllerDetails.controllerName;
	            var hashMapEntry = hashMap[controllerName];
	    ...
	    Dispatcher.prototype.dispatch = function (route) {
	        var controllerDetails = this.controllersHashMap[route.controllerName];
	        if (controllerDetails) {
	            var controller = new controllerDetails.controller(this.mediator);
	    ...
	    Dispatcher.prototype.dispatchAction = function (route, controller) {
	        ...
	        this.triggerEvent(new app_event_1.AppEvent("app.controller." + this.currentControllerName + "." + route.actionName, route.args, null));
	    };
	    return Dispatcher;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEmitter = (function () {
	    ...
	    EventEmitter.prototype.triggerError = function (message) {
	        this.triggerEvent(new app_event_1.AppEvent("app.error", message, null));
	    };
	    EventEmitter.prototype.subscribeToEvents = function (events) {
	        this.events = events;
	        for (var _i = 0, _a = this.events; _i < _a.length; _i++) {
	            var event_1 = _a[_i];
	            this.mediator.subscribe(event_1);
	        }
	    };
	    EventEmitter.prototype.unsubscribeToEvents = function () {
	        for (var _i = 0, _a = this.events; _i < _a.length; _i++) {
	            var event_2 = _a[_i];
	            this.mediator.unsubscribe(event_2);
	        }
	    };
	    return EventEmitter;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = (function (_super) {
	    ...
	    Router.prototype.parseRoute = function (hash) {
	        ...
	        var comp = hash.replace("#", "").split("/");
	        var controller = comp[0] || this.defaultController;
	        var action = comp[1] || this.defaultAction;
	        var args = [];
	        for (var i = 2; i < comp.length; i++) {
	            args.push(comp[i]);
	        }
...
/***/ function(module, exports) {
	...
	var Route = (function () {
	    ...
	    Route.prototype.serialize = function () {
	        var serializationArgs = this.args.map(function (a) { return a.toString(); }).join("/");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = (function (_super) {
	    ...
	    View.prototype.getTemplateAsync = function () {
	        var _this = this;
	        return Q.Promise(function (resolve, reject) {
	            if (_this.templateDelegate === undefined || _this.templateDelegate === null) {
	                _this.loadTemplateAsync()
	                    .then(function (source) {
	                    return _this.compileTemplateAsync(source);
	                })
	                    .then(function (templateDelegate) {
	                    _this.templateDelegate = templateDelegate;
	                    resolve(_this.templateDelegate);
	                })
	                    .catch(function (e) {
	                    reject(e);
	                });
	    ...
	    View.prototype.renderAsync = function (model) {
	        ...
	        return Q.Promise(function (resolve, reject) {
	            _this.getTemplateAsync()
	                .then(function (templateDelegate) {
	                var html = _this.templateDelegate(model);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Parser$parse = __webpack_require__(25);
	
	var _Compiler$compile$precompile = __webpack_require__(30);
	
	var _JavaScriptCompiler = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isArray$indexOf = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _COMPILER_REVISION$REVISION_CHANGES = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var framework_1 = __webpack_require__(1);
	var market_view_1 = __webpack_require__(36);
	var nasdaq_model_1 = __webpack_require__(37);
	var nyse_model_1 = __webpack_require__(38);
	var MarketController = (function (_super) {
	    __extends(MarketController, _super);
	    function MarketController(mediator) {
	        _super.call(this, mediator);
	        this.marketView = new market_view_1.MarketView(mediator);
	        this.nasdaqModel = new nasdaq_model_1.NasdaqModel(mediator);
	        this.nyseModel = new nyse_model_1.NyseModel(mediator);
	    }
	    ...
	    MarketController.prototype.nasdaq = function (args) {
	        this.mediator.publish(new framework_1.AppEvent("app.model.nasdaq.change", null, null));
	    };
	    MarketController.prototype.nyse = function (args) {
	        this.mediator.publish(new framework_1.AppEvent("app.model.nyse.change", null, null));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NyseModel = (function (_super) {
	    ...
	    NyseModel.prototype.initialize = function () {
	        var _this = this;
	        this.subscribeToEvents([
	            new framework_1.AppEvent("app.model.nyse.change", null, function (e, args) {
	                _this.onChange(args);
	            })
	        ]);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var framework_1 = __webpack_require__(1);
	var quote_model_1 = __webpack_require__(40);
	var chart_model_1 = __webpack_require__(41);
	var symbol_view_1 = __webpack_require__(42);
	var chart_view_1 = __webpack_require__(43);
	var SymbolController = (function (_super) {
	    __extends(SymbolController, _super);
	    function SymbolController(mediator) {
	        _super.call(this, mediator);
	        this.quoteModel = new quote_model_1.QuoteModel(mediator);
	        this.chartModel = new chart_model_1.ChartModel(mediator);
	        this.symbolView = new symbol_view_1.SymbolView(mediator);
	        this.chartView = new chart_view_1.ChartView(mediator);
	    }
	    ...
	    SymbolController.prototype.subscribeToControllerActionEvents = function () {
	        var _this = this;
	        this.subscribeToEvents([
	    ...
	    SymbolController.prototype.initializeViews = function () {
	        this.symbolView.initialize();
	        this.chartView.initialize();
	    };
	    SymbolController.prototype.initializeModels = function () {
	...
	var ChartModel = (function (_super) {
	    ...
	    ChartModel.prototype.onChange = function (args) {
	        ...
	        this.getAsync("jsonp", queryString)
	            .then(function (data) {
	            var chartData = formatModel(args, data);
